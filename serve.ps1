...
jekyll s --port 4000 --config _config.yml,_config.dev.yml --force_polling --incremental --trace #--livereload #http://talk.jekyllrb.com/t/bad-file-descriptor-when-using-livereload/1627