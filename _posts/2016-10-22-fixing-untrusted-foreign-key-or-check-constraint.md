...
Note: I wrote on this a while back, totally missed that I had covered this. For an older perspective on this: [Stranger Danger... The need for trust with constraints](http://sheldonhull.com/stranger-danger-the-need-for-trust-with-constraints/)
